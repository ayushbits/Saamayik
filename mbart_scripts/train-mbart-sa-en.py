...
model = MBartForConditionalGeneration.from_pretrained(pretrained_model_name_or_path ='mbart-large-50-many-to-many-nmt')#'mbart-pretrained')#'indicbart') #path stored at the disk
# model.save_pretrained('mbart-large-50-many-to-many-nmt')
# exit()
...
tokenized_datasets = load_from_disk("data/mbart_sa_en_final")

args = Seq2SeqTrainingArguments(
            output_dir='model-sa-en/mbart-sa-en-final',
            logging_dir= 'model-sa-en/mbart-sa-en-final',
...
predictions_data.to_csv(f'mbart_final_{source_lang}_{target_lang}_predictions.csv')