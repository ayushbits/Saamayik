...
model_path = 'byt5-en-sa-final_data1/checkpoint-50000'
model = T5ForConditionalGeneration.from_pretrained(pretrained_model_name_or_path =model_path) #path stored at the disk
...
tokenized_datasets = load_from_disk("data/byt5_en_sa_mkg")
...
predictions_data.to_csv(f'byt5_{source_lang}_{target_lang}_predictions_final.csv')
